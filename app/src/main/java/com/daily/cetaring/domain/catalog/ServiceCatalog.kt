...
object ServiceCatalog {
    ...
    val roles = listOf(
        ...
        ServiceRoleDefinition("chef", "catering-food", "Chef", WorkerType.CHEF, 2200),
        ...
        ServiceRoleDefinition("event-decorator", "decoration", "Event Decorator", WorkerType.EVENT_DECORATOR),
        ...
        ServiceRoleDefinition("dj", "entertainment", "DJ", WorkerType.DJ),
        ServiceRoleDefinition("sound-technician", "entertainment", "Sound Technician", WorkerType.SOUND_TECHNICIAN),
        ServiceRoleDefinition("singer", "entertainment", "Singer", WorkerType.SINGER),
        ...
        ServiceRoleDefinition("makeup-artist", "beauty", "Makeup Artist", WorkerType.MAKEUP_ARTIST),
        ...
        ServiceRoleDefinition("mehendi-artist", "beauty", "Mehendi Artist", WorkerType.MEHENDI_ARTIST),
        ...
        ServiceRoleDefinition("photographer", "photography-video", "Photographer", WorkerType.PHOTOGRAPHER),
        ...
        ServiceRoleDefinition("pujari", "religious-ceremony", "Pujari", WorkerType.PUJARI),
        ...
        ServiceRoleDefinition("event-coordinator", "event-support", "Event Coordinator", WorkerType.EVENT_COORDINATOR),
        ...
        ServiceRoleDefinition("chair-rental-main", "rentals", "Chair Rental", WorkerType.CHAIR_RENTAL, 50),
        ...
        ServiceRoleDefinition("event-driver", "transport-logistics", "Event Driver", WorkerType.EVENT_DRIVER),
        ...
        ServiceRoleDefinition("invitation-designer", "other-event-services", "Invitation Designer", WorkerType.INVITATION_DESIGNER),
